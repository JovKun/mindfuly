...
async def home_page():
    with ui.column().classes('mx-auto'):
        with ui.row().classes('w-full justify-between items-center px-4 mb-4'):
            ui.label('Mindfuly').classes('text-2xl font-bold mb-4')
        ui.button('Login', on_click=lambda: ui.navigate.to('/login')).classes('mt-4')
        ui.button('Signup', on_click=lambda: ui.navigate.to('/signup')).classes('mt-4')
